...
récupérées automatiquement via le web scraping avec **Web scraper nettoyée** ou **Web Scraper non nettoyée** et **Merci de bien vouloir remplir le formulaire** .
""")
...
if st.session_state.page == "home":
    ...
    # Ajout du formulaire KoBoToolbox 
    

    st.markdown("""
    <iframe src=https://ee.kobotoolbox.org/i/XNpaW4VM width="800" height="600"></iframe>
    """, unsafe_allow_html=True)